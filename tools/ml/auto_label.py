...
def auto_label_with_yolo(images_folder, output_labels_folder, model_name, confidence):
...
def main():
    ...
    parser.add_argument("--model", default=ml_params["model"])
    parser.add_argument("--confidence", type=float, default=ml_params["confidence"])
    args = parser.parse_args()
    auto_label_with_yolo(args.images_folder, args.output_labels_folder, args.model, args.confidence)
