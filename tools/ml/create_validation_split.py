...
def create_validation_split(dataset_root, fraction, seed):
...
def main():
    ...
    parser.add_argument("--fraction", type=float, default=ml_params["validation_fraction"])
    parser.add_argument("--seed", type=int, default=ml_params["random_seed"])
    args = parser.parse_args()
    create_validation_split(args.dataset_root, args.fraction, args.seed)
